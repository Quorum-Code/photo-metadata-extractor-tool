...
def par_img_proc_caller(img_dir, progress_signal, total_images):
    ...
    for worker in range(num_workers):
        extracted_data.append(exe.submit(img_recognition,
                                         img_list_split[worker],
                                         processor_typed,
                                         model_typed,
                                         processor_hw,
                                         model_hw,
                                         ...
                                         total_images,
                                         progress_signal))
        # extracted_data.append(exe.submit(img_recognition, img_list_split[worker], processor_typed, model_typed,
        # processor_hw, model_hw, writing_classifier,
